...
export const SupervisorCallCard = ({ reservation, isSelected = false, onSelect }: Props) => {
    if (!reservation) {
        return (
            <Box
                display="flex"
    ...
    const phoneNumber = reservation.attributes?.from || reservation.attributes?.outbound_to || "Unknown";
    ...
    return (
        ...
        >
            <Box
                ...
                flexShrink={0}
            >
                <CallIncomingIcon decorative size="sizeIcon40" color="colorTextIconAvailable" />
            </Box>
